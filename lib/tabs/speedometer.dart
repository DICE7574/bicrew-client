...
double calculateDistance(double lat1, double lon1, double lat2, double lon2) {
  ...
  double distance = math.acos(math.sin(lat1)*math.sin(lat2)+math.cos(lat1)*math.cos(lat2)*math.cos(lon2-lon1)) * earthRadius;
...
class SpeedometerViewState extends State<SpeedometerView> {
  ...
  void _updateTimer(Timer timer) {
    ...
    if(_realtime > 0){
      _distance = calculateDistance(_latitude, _longitude, _pLatitude, _pLongitude);
      if(_testMode){
